...
from torch_geometric.data import RandomNodeSampler, NeighborSampler, GraphSAINTRandomWalkSampler,GraphSAINTNodeSampler
...
parser.add_argument('--prune_ratio', type=float, default=1)
...
train_loader = GraphSAINTNodeSampler(data,
                                         batch_size=args.batch_size,
                                         num_steps=args.num_steps,
                                         sample_coverage=0,
                                         save_dir=dataset.processed_dir)
test_loader = GraphSAINTNodeSampler(data,
                                         batch_size=args.batch_size,
                                         num_steps=args.num_steps,
                                         sample_coverage=0,
                                         save_dir=dataset.processed_dir)

p_train_loader = GraphSAINTNodeSampler(data,
...
print(f'reweight is {args.reweight}')
